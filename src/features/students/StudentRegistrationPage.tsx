...
const StudentRegistrationPage = () => {
  ...
  return (
    <div className="p-8 space-y-4">
      ...
      <p className="text-gray-500 text-sm mt-1 ml-20">Active Student Profile</p>
          ...
          <div className="text-center mb-8 relative">
            {student.photo_path ? (
              <div className="relative inline-block">
                ...
                <div className="absolute bottom-6 right-6 w-6 h-6 bg-green-500 rounded-full border-4 border-white"></div>
              </div>
            ) : (
              <div className="relative inline-block">
...
const ProfileSkeleton = () => (
  <div className="animate-pulse p-8 space-y-4">
    ...
    <div className="h-4 w-32 bg-gray-200 rounded ml-20"></div>
    <div className="grid grid-cols-1 lg:grid-cols-[40%_60%] gap-8">
